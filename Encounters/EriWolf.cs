    ...
    internal class EriWolf
    {
		public static void AddEncounter()
		{
            ...
            turn_1.Add(new EncounterBlueprintData.CardBlueprint
            {
                ...
                difficultyReplace = CardLoader.GetCardByName("eri_Jackal"),
                difficultyReq = 18,
            ...
            {
                card = CardLoader.GetCardByName("WolfCub"),
                difficultyReplace = CardLoader.GetCardByName("Alpha"),
                difficultyReq = 13,
                randomReplaceChance = 25
            });
            ...
            {
                card = CardLoader.GetCardByName("WolfCub"),
                difficultyReplace = CardLoader.GetCardByName("eri_WhiteWolf"),
                difficultyReq = 13,
                randomReplaceChance = 25
            });
            ...
            turn_4.Add(new EncounterBlueprintData.CardBlueprint
            {
                ...
                difficultyReplace = CardLoader.GetCardByName("eri_Hyena"),
                difficultyReq = 18,
                randomReplaceChance = 25
            });
